    ...
    <div className="max-w-4xl mx-auto p-6 h-screen flex flex-col">
      ...
      <div className="mb-6">
        ...
        <div className="text-center">
          ...
          <p className="text-gray-600">Get personalized career guidance, job search tips, and upskilling recommendations</p>
        </div>
      </div>
            ...
            <div className="flex flex-wrap gap-2">
              {quickQuestions.map((question, index) => (
                <button
                  ...
                  className="px-3 py-2 bg-white border border-gray-200 rounded-lg text-sm text-gray-700 hover:bg-blue-50 hover:border-blue-300 hover:text-blue-700 transition-colors"
                >
                  {question}
                </button>
              ))}
          ...
          <div className="flex space-x-4">
            <div className="flex-1 relative">
              <textarea
                ...
                className="w-full p-3 pr-12 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 resize-none"
                rows={1}
              ...
              <button
                ...
                className="absolute right-2 top-2 p-2 bg-gradient-to-r from-purple-600 to-blue-600 text-white rounded-lg hover:from-purple-700 hover:to-blue-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all"
              >
