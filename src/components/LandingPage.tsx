  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50">
      ...
      <section id="about" className="py-12 lg:py-20 bg-gray-50">
        <div className="container mx-auto px-4 lg:px-6">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-12 text-center">About TalentConnect</h2>
        ...
        <div className="container mx-auto px-4 lg:px-6">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl lg:text-2xl text-gray-800 leading-relaxed mb-8 italic">
              "TalentConnect understood what we were looking for and saved us a lot of time. The candidates they shared were well matched and the process was smooth from start to finish."
            </p>
          ...
          <div className="grid md:grid-cols-2 gap-8 lg:gap-12 mb-8 lg:mb-12">
            ...
            <div>
              ...
              <nav className="space-y-2">
                ...
                <a href="#about" className="text-gray-400 hover:text-white transition-colors text-sm lg:text-base block">About Us</a>
